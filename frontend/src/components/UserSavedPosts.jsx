...
const UserSavedPosts = () => {
  const { currentUser, selectedPost, setShowUserSavedPosts } = useContext(AppContext);
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-80 flex items-center justify-center z-50 p-4">
      ...
      <div className='absolute top-10 right-20'>
        <img src={assets.cross_icon} alt="" className='w-5 cursor-pointer' onClick={() => setShowUserSavedPosts(false)}/>
      </div>

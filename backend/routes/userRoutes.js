...
import { addComment, editProfile, getPostComments, getUserByUsername, getUserData, likePost, removeProfileImage, savePost, searchUsers, unlikePost, unsavePost, uploadProfileImage, verifyUser } from "../controllers/userController.js"
...
router.patch("/verify-user/:userId", userAuth,verifyUser);
